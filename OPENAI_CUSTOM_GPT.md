...
| `GET /v1/stories/{storyId}/similar` | Stories most similar (tag + title overlap) | `Reports.SimilarStories` |
| `GET /v1/stories/{storyId}/title-history` | Recorded title changes over time | `title-history.csv` |
| `GET /v1/reports/patterns` | Structural title patterns + avg read ratio/earnings | `Reports.TitlePatterns` |
